...
//changed height/width to 500 and 500 - ao
    ...
    class SnakePanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            if (gameOver > 6) {                 // If gameOver indicates game is won, display message
                g.setColor(Color.CYAN); //changed endgame text to cyan - ao
                ...
                g.setColor(Color.MAGENTA); //changed kibble to magenta - ao
                g.fillRect(kibble[0] * squareSize, kibble[1] * squareSize, squareSize, squareSize);

                g.setColor(Color.LIGHT_GRAY); // changed snake to light gray - ao
